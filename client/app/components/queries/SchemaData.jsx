...
class SchemaData extends React.PureComponent {
  ...
  render() {
    ...
    const hasDescription = this.props.tableMetadata.some(columnMetadata => columnMetadata.description);

    const hasExample = this.props.tableMetadata.some(columnMetadata => columnMetadata.example);
