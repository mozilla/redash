    ...
    sub.$save(
      () => {
        ...
        this.setState({
          ...
          destinations: this.state.destinations.filter(d => d.id !== this.state.selection),
          selection: this.state.destinations && this.state.destinations[0].id,
        });
      },
      () => {
    ...
    return (
      <div className="p-5">
        ...
        <div>
          ...
          >
            {this.state.destinations.map(d => <Select.Option key={d.id}><Destination destination={d} /></Select.Option>)}
          </Select>
        </div>
        <div className="m-t-5">
          <button
