...
SCHEMA_REFRESH_TIME_LIMIT = int(os.environ.get("REDASH_SCHEMA_REFRESH_TIME_LIMIT", 1500))
SCHEMA_REFRESH_SOFT_TIME_LIMIT = int(os.environ.get("REDASH_SCHEMA_REFRESH_SOFT_TIME_LIMIT", 1200))
if SCHEMA_REFRESH_TIME_LIMIT < SCHEMA_REFRESH_SOFT_TIME_LIMIT:
    raise ValueError("SCHEMA_REFRESH_TIME_LIMIT must be bigger than SCHEMA_REFRESH_SOFT_TIME_LIMIT")
